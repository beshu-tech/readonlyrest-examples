...
| [pki-authentication](examples/pki-authentication) | Services authenticating with a TLS client certificate instead of a password, with the username and groups read from the certificate |
