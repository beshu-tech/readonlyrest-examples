...
### Step 1 — Elasticsearch starts with ReadonlyREST
...
### Step 2 — Kibana starts with ReadonlyREST Kibana plugin
...
### Step 3 — Fleet Server enrolls itself
...
### Step 4 — Fleet Initializer configures agent policies (one-shot)
...
### Step 5 — APM Agent enrolls and starts the APM Server
...
### Step 7 — Traffic Simulator generates load
